...
//        "100" to listOf("one hundred", "100", "वान हण्ड्रेड", "one hundred", "हन्ड्रेड", "१००", "१००ड"),
    ...
    val phoneticKoreanMapping = mapOf(
        ...
        "ㅂ" to listOf("ब्", "फ्", "ba", "pha", "फ"),
        "ㅅ" to listOf("स्", "sa", "सा", "स"),
        "ㅇ" to listOf("अ", "ङ्", "A", "na", "अङ्", "un"),
        "ㅈ" to listOf("ज्", "छ्", "Ja", "chha", "जछ"),
...
//        vowels
        ...
        "ㅛ" to listOf("यो", "yo"),
        "ㅜ" to listOf("उ", "u", "wu"),
        "ㅠ" to listOf("यु", "yu", "you"),
        "ㅡ" to listOf("ऊ", "u"),
        "ㅣ" to listOf("इ", "ee", "e"),
        "ㅐ" to listOf("ए", "a"),
        "ㅔ" to listOf("ऐ", "ae", "ei", "i", "अई"),
        "ㅒ" to listOf("ये", "ye", "yae"),
        "ㅖ" to listOf("ये", "ye", "yaae"),
        "ㅟ" to listOf("वी", "wi", "wee"),
        "ㅢ" to listOf("उइ", "उई", "wi", "eui", "ui"),
        "ㅘ" to listOf("वा", "waa"),
        "ㅝ" to listOf("व", "wa", "ब"),
        "ㅚ" to listOf("वे", "we", "oe", "way"),
        "ㅙ" to listOf("वै", "huai", "wae", "oye", "oil", "ओए", "huawei", "y"),
        "ㅞ" to listOf("वे", "we")
    )
}